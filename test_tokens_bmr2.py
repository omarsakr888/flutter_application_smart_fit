...
blocks = extractor._section_blocks(scan.image, img_w, img_h, template, "bmr_standalone", preprocess=True)
print("Blocks near BMR (preprocessed):")
for b in blocks:
    if "BMR" in b.text or "Basal" in b.text or any(c.isdigit() for c in b.text):
        if 720 < b.cy < 820:
